...
os.system("sbatch -A {profile} --export=ALL --parsable -p core -n {threads} --time={days:d}-{hours:02d}:00:00 --job-name={name} {script}".format(script=jobscript, **cluster_param))
#
